...
struct HyperParameter {
    ...
    inline bool show_summary() const { return verbosity >= 1; }
    inline bool show_round_metrics() const { return verbosity >= 2; }
};
...
public:
    ...
    inline pair<double, int> best() const {
        return info;
    }

    inline void print_best() const {
